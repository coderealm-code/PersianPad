...
class TextJustificationController(QObject):
    def __init__(self, editor: QTextEdit, widget: TextJustify, parent=None):
        super().__init__(parent)
        self.editor = editor
        self.text_justification = widget
    ...
    def _connect_signals(self) -> None:
        ...
        self.text_justification.request_justify.connect(self.justify)
