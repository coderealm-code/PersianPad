...
from PySide6.QtWidgets import QFrame, QVBoxLayout, QHBoxLayout, QGroupBox, QApplication, QLabel, QPushButton, QLineEdit, QCheckBox
...
class SearchDialog(QWidget):
    ...
    def body(self) -> QFrame:
        ...
        search_entry: QLineEdit = QLineEdit(parent=body_frame)
        search_entry.setFixedSize(BodyMetric.line_edit_width, BodyMetric.line_edit_height)
        search_entry.setObjectName("search_entry")
        search_entry.setPlaceholderText("متن مورد نظر...")
        search_entry.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
    ...
    def buttons_part(self) -> QFrame:
        ...
        for btn, obj in zip(btn_list, obj_names):
